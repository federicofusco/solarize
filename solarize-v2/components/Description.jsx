 ...
 * 
 * @param {String} name - The description's title
 * @param {String} description - The decription body
 * @param {Object[]} sources - The description's sources
 * @param {Object[]} uses - A list of uses
